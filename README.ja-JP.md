...
<img src="docs/images/architecture-diagram.png" alt="アーキテクチャ図: リソースグループ、Container Apps 環境（GPU ワークロードプロファイル）、Ollama と nginx 認証プロキシの 2 コンテナを含む Container App" width="600">
